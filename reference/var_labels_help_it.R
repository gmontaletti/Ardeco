# ==============================================================================
# var_labels_help_it.R
# Bozza della colonna help_it (spiegazione approfondita della variabile +
# indicazioni di lettura del valore) per la tabella var_labels di
# data/ardeco.duckdb. var_code, group_id, label_it, description_it sono
# riportati invariati da R/01_build_duckdb.R per coerenza; help_it e' la
# nuova colonna proposta, non ancora integrata nella pipeline (vedi nota
# accanto alla definizione di var_labels in R/01_build_duckdb.R e in
# R/run_pipeline.R).
# Output: reference/var_labels_help_it.csv
# ==============================================================================
...
stopifnot(nrow(var_labels_help_it) == 57L)
stopifnot(!anyNA(var_labels_help_it$help_it))

# 3. Scrittura CSV -----

out_path <- here::here("reference", "var_labels_help_it.csv")
fwrite(var_labels_help_it, out_path)
message("Scritto: ", out_path, " (", nrow(var_labels_help_it), " righe)")
